...
pub fn setup_with_precomputations<
  E: Engine,
  C: Circuit<E>,
...
>(
  ...
  (
    RedshiftSetup<E::Fr, FriSpecificBlake2sTree<E::Fr>>,
    RedshiftSetupPrecomputation<E::Fr, FriSpecificBlake2sTree<E::Fr>>,
  ),
  SynthesisError,
>
where
  E::Fr: PartialTwoBitReductionField,
{
  ...
  let q_l_commitment_data =
    ProvingAssembly::<E>::commit_single_poly(&q_l, omegas_bitreversed, &params, &worker)?;
  let q_r_commitment_data =
    ProvingAssembly::<E>::commit_single_poly(&q_r, omegas_bitreversed, &params, &worker)?;
  let q_o_commitment_data =
    ProvingAssembly::<E>::commit_single_poly(&q_o, omegas_bitreversed, &params, &worker)?;
  let q_m_commitment_data =
    ProvingAssembly::<E>::commit_single_poly(&q_m, omegas_bitreversed, &params, &worker)?;
  let q_c_commitment_data =
    ProvingAssembly::<E>::commit_single_poly(&q_c, omegas_bitreversed, &params, &worker)?;
  let s_id_commitment_data =
    ProvingAssembly::<E>::commit_single_poly(&s_id, omegas_bitreversed, &params, &worker)?;
  let sigma_1_commitment_data =
    ProvingAssembly::<E>::commit_single_poly(&sigma_1, omegas_bitreversed, &params, &worker)?;
  let sigma_2_commitment_data =
    ProvingAssembly::<E>::commit_single_poly(&sigma_2, omegas_bitreversed, &params, &worker)?;
  let sigma_3_commitment_data =
    ProvingAssembly::<E>::commit_single_poly(&sigma_3, omegas_bitreversed, &params, &worker)?;
