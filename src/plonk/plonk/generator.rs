...
pub fn setup_with_precomputations<E: Engine, C: Circuit<E>, CP: CTPrecomputations<E::Fr>>(
  ...
  let q_l_lde =
    q_l.bitreversed_lde_using_bitreversed_ntt(&worker, 4, omegas_bitreversed, &coset_generator)?;
  let q_r_lde =
    q_r.bitreversed_lde_using_bitreversed_ntt(&worker, 4, omegas_bitreversed, &coset_generator)?;
  let q_o_lde =
    q_o.bitreversed_lde_using_bitreversed_ntt(&worker, 4, omegas_bitreversed, &coset_generator)?;
  let q_m_lde =
    q_m.bitreversed_lde_using_bitreversed_ntt(&worker, 4, omegas_bitreversed, &coset_generator)?;
  let q_c_lde =
    q_c.bitreversed_lde_using_bitreversed_ntt(&worker, 4, omegas_bitreversed, &coset_generator)?;

  let s_id_lde =
    s_id.bitreversed_lde_using_bitreversed_ntt(&worker, 4, omegas_bitreversed, &coset_generator)?;

  let sigma_1_lde = sigma_1.bitreversed_lde_using_bitreversed_ntt(
    &worker,
    4,
    omegas_bitreversed,
    &coset_generator,
  )?;
  let sigma_2_lde = sigma_2.bitreversed_lde_using_bitreversed_ntt(
    &worker,
    4,
    omegas_bitreversed,
    &coset_generator,
  )?;
  let sigma_3_lde = sigma_3.bitreversed_lde_using_bitreversed_ntt(
    &worker,
    4,
    omegas_bitreversed,
    &coset_generator,
