...
pub fn prove_by_steps<E: Engine, C: crate::Circuit<E>, T: Transcript<E::Fr>>(
  ...
  let mut precomputed_omegas = crate::plonk::better_cs::prover::prove_steps::PrecomputedOmegas::<
    E::Fr,
    BitReversedOmegas<E::Fr>,
  >::None;
  let mut precomputed_omegas_inv = crate::plonk::better_cs::prover::prove_steps::PrecomputedOmegas::<
    E::Fr,
    OmegasInvBitreversed<E::Fr>,
  >::None;
